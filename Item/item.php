    ...
    <table id="example" class="w-full text-center border-collapse text-sm font-medium">
      <thead class="bg-blue-200">
        <tr>
          ...
          <th class="border px-4 py-2">Nomor Barang</th>
      ...
      <tbody>
       <?php
        ...
        while ($data = mysqli_fetch_array($query)) {
          $sidebarId = "sidebar-edit-" . $data['NO_ITEM'];
        ?>
          <tr class="hover:bg-gray-100">
            <td class="border px-4 py-2"><?php echo $no++; ?></td>
            <td class="border px-4 py-2"><?php echo $data['NO_ITEM']; ?></td>
            <td class="border px-4 py-2"><?php echo $data['Nama_Barang']; ?></td>
            <td class="border px-4 py-2 text-left"><?php echo $data['Satuan']; ?></td>
            <td class="border px-4 py-2"><?php echo $data['Harga_Satuan']; ?></td>
         ...
         <?php include("itemapus.php");  ?>
         <?php include("itemubah.php");  ?>
         <?php } ?>
