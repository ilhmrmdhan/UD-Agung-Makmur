...
<body class="flex h-screen bg-gray-200 font-sans">
  ...
  <?php include("pegawaitambah.php"); ?>

 <!-- Tombol Buka Sidebar -->
<main class="flex-1 p-6 m-20 mt-8 overflow-auto rounded-md bg-white">
  <div class="flex justify-between items-center mt-6">
    <h2 class="text-2xl font-bold mb-4">Table Pegawai</h2>   
      ...
      <tbody>
       <?php
        ...
        while ($data = mysqli_fetch_array($query)) {
          $sidebarId = "sidebar-edit-" . $data['ID_PEGAWAI'];
        ?>
          <tr class="hover:bg-gray-100">
            <td class="border px-4 py-2"><?php echo $no++; ?></td>
            <td class="border px-4 py-2"><?php echo $data['ID_PEGAWAI']; ?></td>
            <td class="border px-4 py-2 text-left"><?php echo $data['Nama_Pegawai']; ?></td>
            <td class="border px-4 py-2"><?php echo $data['Jabatan']; ?></td>
            <td class="border px-4 py-2"><?php echo $data['No_Hp']; ?></td>
         ...
         <?php include("pegawaihapus.php");  ?>
         <?php include("pegawaiubah.php");  ?>
         <?php } ?>
