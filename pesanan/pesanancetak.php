    ...
    <div
        ...
        <div class="border border-black-2 p-2 mb-2">
            <ul style="list-style: none; padding-left: 0; margin: 2px;">
                <li>NO PESANAN:&nbsp;&nbsp;&nbsp;<?php echo $data['NO_TRANSAKSI']; ?></li>
                <li>Vendor:&nbsp;&nbsp;&nbsp;<?php echo $data['Nama_Supplier']; ?></li>
        ...
        <div class="p-2">
            <ul>
                <li>Pembeli:&nbsp;&nbsp;&nbsp;<?php echo $data['NO_TRANSAKSI']; ?></li>
                <li>No Hp:&nbsp;&nbsp;&nbsp;<?php echo $data['Nama_PT']; ?></li>
                <li>Alamat:&nbsp;&nbsp;&nbsp;<?php echo $data['Alamat_PT']; ?></li>
            </ul>
        </div>
